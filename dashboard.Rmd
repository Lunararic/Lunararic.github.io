...
### Scatterplots for Maximum and Minimum temperature from 2008 to 2010 

```{r}
noaa_tidy %>%
  filter(tmax != "", tmin != "", year == 2008 | year == 2009 | year == 2010) %>%
...
```{r}
noaa_tidy %>% 
  filter(tmin != "", year == 2006 | year == 2007 |year == 2008 | year == 2009 | year == 2010) %>% 
