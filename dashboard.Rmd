...
### Scatterplot for Maximum and Minimum temperature from 2007 to 2010 

```{r}
noaa_tidy %>%
  filter(tmax != "", tmin != "", year == 2007 |year == 2008 | year == 2009 | year == 2010) %>%
...
### Barplot for Precipitation over 12 months in 2010
